...
public class BiomeModificationModuleFabric {
    ...
    private static void addFeaturesToBiomes() {
        ...
        BiomeModifications.create(Identifier.fromNamespaceAndPath(YungsExtrasCommon.MOD_ID, "vanilla_desert_well_removal"))
    ...
    private static void addToDesertBiome(String featurePath, GenerationStep.Decoration step) {
        BiomeModifications.create(Identifier.fromNamespaceAndPath(YungsExtrasCommon.MOD_ID, featurePath))
                .add(ModificationPhase.ADDITIONS,
                        context -> context.hasTag(TagKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(YungsExtrasCommon.MOD_ID, "has_structure/desert_decorations"))),
                        context -> context.getGenerationSettings().addFeature(step, ResourceKey.create(Registries.PLACED_FEATURE, Identifier.fromNamespaceAndPath(YungsExtrasCommon.MOD_ID, featurePath))));
    }

    private static void addToSwampBiome(String featurePath, GenerationStep.Decoration step) {
        BiomeModifications.create(Identifier.fromNamespaceAndPath(YungsExtrasCommon.MOD_ID, featurePath))
                .add(ModificationPhase.ADDITIONS,
                        context -> context.hasTag(TagKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(YungsExtrasCommon.MOD_ID, "has_structure/swamp_structures"))),
                        context -> context.getGenerationSettings().addFeature(step, ResourceKey.create(Registries.PLACED_FEATURE, Identifier.fromNamespaceAndPath(YungsExtrasCommon.MOD_ID, featurePath))));
    }
}
