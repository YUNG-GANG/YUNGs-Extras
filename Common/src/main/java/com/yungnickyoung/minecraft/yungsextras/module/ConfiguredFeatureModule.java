...
public class ConfiguredFeatureModule {
    ...
    public static List<PlacementModifier> placement(int rarity) {
        return List.of(
    ...
    public static final NamedConfiguredFeature WELL_SM_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_WELL, new DesertWellFeatureConfiguration("desert/wells/well_sm", 1)),
            "desert_well_sm");
    public static final NamedPlacedFeature WELL_SM_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(WELL_SM_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.wells.smallNormalWellSpawnRate)),
            "desert_well_sm",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature WELL_MD_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_WELL, new DesertWellFeatureConfiguration("desert/wells/well_md", 2)),
            "desert_well_md");
    public static final NamedPlacedFeature WELL_MD_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(WELL_MD_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.wells.mediumNormalWellSpawnRate)),
            "desert_well_md",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature WELL_LG_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_WELL, new DesertWellFeatureConfiguration("desert/wells/well_lg", 3)),
            "desert_well_lg");
    public static final NamedPlacedFeature WELL_LG_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(WELL_LG_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.wells.largeNormalWellSpawnRate)),
            "desert_well_lg",
            Biome.BiomeCategory.DESERT);

    /* Dry wells */
    public static final NamedConfiguredFeature DRY_WELL_SM_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_WELL, new DesertWellFeatureConfiguration("desert/wells/dry_well_sm", 1)),
            "desert_dry_well_sm");
    public static final NamedPlacedFeature DRY_WELL_SM_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(DRY_WELL_SM_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.wells.smallDryWellSpawnRate)),
            "desert_dry_well_sm",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature DRY_WELL_MD_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_WELL, new DesertWellFeatureConfiguration("desert/wells/dry_well_md", 2)),
            "desert_dry_well_md");
    public static final NamedPlacedFeature DRY_WELL_MD_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(DRY_WELL_MD_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.wells.mediumDryWellSpawnRate)),
            "desert_dry_well_md",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature DRY_WELL_LG_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_WELL, new DesertWellFeatureConfiguration("desert/wells/dry_well_lg", 3)),
            "desert_dry_well_lg");
    public static final NamedPlacedFeature DRY_WELL_LG_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(DRY_WELL_LG_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.wells.largeDryWellSpawnRate)),
            "desert_dry_well_lg",
            Biome.BiomeCategory.DESERT);

    /* Wishing wells */
    public static final NamedConfiguredFeature WISHING_WELL_SM_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_WELL, new DesertWellFeatureConfiguration("desert/wells/wishing_well_sm", 1)),
            "desert_wishing_well_sm");
    public static final NamedPlacedFeature WISHING_WELL_SM_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(WISHING_WELL_SM_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.wells.smallWishingWellSpawnRate)),
            "desert_wishing_well_sm",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature WISHING_WELL_MD_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_WELL, new DesertWellFeatureConfiguration("desert/wells/wishing_well_md", 2)),
            "desert_wishing_well_md");
    public static final NamedPlacedFeature WISHING_WELL_MD_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(WISHING_WELL_MD_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.wells.mediumWishingWellSpawnRate)),
            "desert_wishing_well_md",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature WISHING_WELL_LG_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_WELL, new DesertWellFeatureConfiguration("desert/wells/wishing_well_lg", 3)),
            "desert_wishing_well_lg");
    public static final NamedPlacedFeature WISHING_WELL_LG_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(WISHING_WELL_LG_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.wells.largeWishingWellSpawnRate)),
            "desert_wishing_well_lg",
            Biome.BiomeCategory.DESERT);

    /* Obelisks */
    public static final NamedConfiguredFeature OBELISK_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_OBELISK, new ResourceLocationFeatureConfiguration("desert/obelisk/obelisk")),
            "desert_obelisk");
    public static final NamedPlacedFeature OBELISK_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(OBELISK_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.obelisks.normalObeliskSpawnRate)),
            "desert_obelisk",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature OBELISK_CREEPER_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_OBELISK, new ResourceLocationFeatureConfiguration("desert/obelisk/obelisk_creeper")),
            "desert_obelisk_creeper");
    public static final NamedPlacedFeature OBELISK_CREEPER_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(OBELISK_CREEPER_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.obelisks.creeperObeliskSpawnRate)),
            "desert_obelisk_creeper",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature OBELISK_RUINED_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_OBELISK, new ResourceLocationFeatureConfiguration("desert/obelisk/obelisk_ruined")),
            "desert_obelisk_ruined");
    public static final NamedPlacedFeature OBELISK_RUINED_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(OBELISK_RUINED_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.obelisks.ruinedObeliskSpawnRate)),
            "desert_obelisk_ruined",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature OBELISK_RARE_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_OBELISK, new ResourceLocationFeatureConfiguration("desert/obelisk/obelisk_rare")),
            "desert_obelisk_rare");
    public static final NamedPlacedFeature OBELISK_RARE_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(OBELISK_RARE_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.obelisks.blackstoneObeliskSpawnRate)),
            "desert_obelisk_rare",
            Biome.BiomeCategory.DESERT);

    /* Miscellaneous Desert Features */
    public static final NamedConfiguredFeature GIANT_TORCH_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_GIANT_TORCH, FeatureConfiguration.NONE),
            "desert_giant_torch");
    public static final NamedPlacedFeature GIANT_TORCH_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(GIANT_TORCH_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.misc.giantTorchSpawnRate)),
            "desert_giant_torch",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature DESERT_RUINS_0_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_RUINS_0, FeatureConfiguration.NONE),
            "desert_ruins_0");
    public static final NamedPlacedFeature DESERT_RUINS_0_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(DESERT_RUINS_0_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.misc.smallRuinsSpawnRate)),
            "desert_ruins_0",
            Biome.BiomeCategory.DESERT);

    public static final NamedConfiguredFeature DESERT_CHILLZONE_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.DESERT_CHILLZONE, FeatureConfiguration.NONE),
            "desert_chillzone");
    public static final NamedPlacedFeature DESERT_CHILLZONE_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(DESERT_CHILLZONE_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.desert.misc.chillzoneSpawnRate)),
            "desert_chillzone",
            Biome.BiomeCategory.DESERT);
    ...
    public static final NamedConfiguredFeature SWAMP_PILLAR_0_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_PILLAR, new ResourceLocationFeatureConfiguration("swamp/pillar/swamp_pillar_0")),
            "swamp_pillar_0");
    public static final NamedPlacedFeature SWAMP_PILLAR_0_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_PILLAR_0_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.pillarSpawnRate)),
            "swamp_pillar_0",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_PILLAR_1_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_PILLAR, new ResourceLocationFeatureConfiguration("swamp/pillar/swamp_pillar_1")),
            "swamp_pillar_1");
    public static final NamedPlacedFeature SWAMP_PILLAR_1_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_PILLAR_1_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.pillarSpawnRate)),
            "swamp_pillar_1",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_PILLAR_2_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_PILLAR, new ResourceLocationFeatureConfiguration("swamp/pillar/swamp_pillar_2")),
            "swamp_pillar_2");
    public static final NamedPlacedFeature SWAMP_PILLAR_2_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_PILLAR_2_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.pillarSpawnRate)),
            "swamp_pillar_2",
            Biome.BiomeCategory.SWAMP);

    /* Cubbies */
    public static final NamedConfiguredFeature SWAMP_CUBBY_0_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_CUBBY, new ResourceLocationFeatureConfiguration("swamp/cubby/swamp_cubby_0")),
            "swamp_cubby_0");
    public static final NamedPlacedFeature SWAMP_CUBBY_0_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_CUBBY_0_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.cubbySpawnRate)),
            "swamp_cubby_0",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_CUBBY_1_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_CUBBY, new ResourceLocationFeatureConfiguration("swamp/cubby/swamp_cubby_1")),
            "swamp_cubby_1");
    public static final NamedPlacedFeature SWAMP_CUBBY_1_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_CUBBY_1_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.cubbySpawnRate)),
            "swamp_cubby_1",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_CUBBY_2_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_CUBBY, new ResourceLocationFeatureConfiguration("swamp/cubby/swamp_cubby_2")),
            "swamp_cubby_2");
    public static final NamedPlacedFeature SWAMP_CUBBY_2_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_CUBBY_2_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.cubbySpawnRate)),
            "swamp_cubby_2",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_CUBBY_3_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_CUBBY, new ResourceLocationFeatureConfiguration("swamp/cubby/swamp_cubby_3")),
            "swamp_cubby_3");
    public static final NamedPlacedFeature SWAMP_CUBBY_3_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_CUBBY_3_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.cubbySpawnRate)),
            "swamp_cubby_3",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_CUBBY_4_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_CUBBY, new ResourceLocationFeatureConfiguration("swamp/cubby/swamp_cubby_4")),
            "swamp_cubby_4");
    public static final NamedPlacedFeature SWAMP_CUBBY_4_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_CUBBY_4_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.cubbySpawnRate)),
            "swamp_cubby_4",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_CUBBY_5_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_CUBBY, new ResourceLocationFeatureConfiguration("swamp/cubby/swamp_cubby_5")),
            "swamp_cubby_5");
    public static final NamedPlacedFeature SWAMP_CUBBY_5_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_CUBBY_5_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.cubbySpawnRate)),
            "swamp_cubby_5",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_CUBBY_6_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_CUBBY, new ResourceLocationFeatureConfiguration("swamp/cubby/swamp_cubby_6")),
            "swamp_cubby_6");
    public static final NamedPlacedFeature SWAMP_CUBBY_6_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_CUBBY_6_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.cubbySpawnRate)),
            "swamp_cubby_6",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_CUBBY_7_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_CUBBY, new ResourceLocationFeatureConfiguration("swamp/cubby/swamp_cubby_7")),
            "swamp_cubby_7");
    public static final NamedPlacedFeature SWAMP_CUBBY_7_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_CUBBY_7_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.cubbySpawnRate)),
            "swamp_cubby_7",
            Biome.BiomeCategory.SWAMP);

    /* Arches */
    public static final NamedConfiguredFeature SWAMP_ARCH_0_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_ARCH, new ResourceLocationFeatureConfiguration("swamp/arch/swamp_arch_0")),
            "swamp_arch_0");
    public static final NamedPlacedFeature SWAMP_ARCH_0_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_ARCH_0_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.archSpawnRate)),
            "swamp_arch_0",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_ARCH_1_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_ARCH, new ResourceLocationFeatureConfiguration("swamp/arch/swamp_arch_1")),
            "swamp_arch_1");
    public static final NamedPlacedFeature SWAMP_ARCH_1_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_ARCH_1_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.archSpawnRate)),
            "swamp_arch_1",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_ARCH_2_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_ARCH, new ResourceLocationFeatureConfiguration("swamp/arch/swamp_arch_2")),
            "swamp_arch_2");
    public static final NamedPlacedFeature SWAMP_ARCH_2_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_ARCH_2_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.archSpawnRate)),
            "swamp_arch_2",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_ARCH_3_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_ARCH, new ResourceLocationFeatureConfiguration("swamp/arch/swamp_arch_3")),
            "swamp_arch_3");
    public static final NamedPlacedFeature SWAMP_ARCH_3_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_ARCH_3_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.archSpawnRate)),
            "swamp_arch_3",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_ARCH_4_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_ARCH, new ResourceLocationFeatureConfiguration("swamp/arch/swamp_arch_4")),
            "swamp_arch_4");
    public static final NamedPlacedFeature SWAMP_ARCH_4_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_ARCH_4_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.archSpawnRate)),
            "swamp_arch_4",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_ARCH_5_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_ARCH, new ResourceLocationFeatureConfiguration("swamp/arch/swamp_arch_5")),
            "swamp_arch_5");
    public static final NamedPlacedFeature SWAMP_ARCH_5_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_ARCH_5_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.archSpawnRate)),
            "swamp_arch_5",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_ARCH_6_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_ARCH, new ResourceLocationFeatureConfiguration("swamp/arch/swamp_arch_6")),
            "swamp_arch_6");
    public static final NamedPlacedFeature SWAMP_ARCH_6_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_ARCH_6_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.archSpawnRate)),
            "swamp_arch_6",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_ARCH_7_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_ARCH, new ResourceLocationFeatureConfiguration("swamp/arch/swamp_arch_7")),
            "swamp_arch_7");
    public static final NamedPlacedFeature SWAMP_ARCH_7_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_ARCH_7_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.archSpawnRate)),
            "swamp_arch_7",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_ARCH_8_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_ARCH, new ResourceLocationFeatureConfiguration("swamp/arch/swamp_arch_8")),
            "swamp_arch_8");
    public static final NamedPlacedFeature SWAMP_ARCH_8_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_ARCH_8_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.archSpawnRate)),
            "swamp_arch_8",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_ARCH_10_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_ARCH, new ResourceLocationFeatureConfiguration("swamp/arch/swamp_arch_10")),
            "swamp_arch_10");
    public static final NamedPlacedFeature SWAMP_ARCH_10_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_ARCH_10_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.archSpawnRate)),
            "swamp_arch_10",
            Biome.BiomeCategory.SWAMP);
    ...
    public static final NamedConfiguredFeature SWAMP_OGRE_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_OGRE, new ResourceLocationFeatureConfiguration("swamp/misc/swamp_ogre_0")),
            "swamp_ogre");
    public static final NamedPlacedFeature SWAMP_OGRE_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_OGRE_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.ogreSpawnRate)),
            "swamp_ogre",
            Biome.BiomeCategory.SWAMP);

    public static final NamedConfiguredFeature SWAMP_CHURCH_CONFIGURED = addConfiguredFeature(
            new ConfiguredFeature<>(FeatureModule.SWAMP_CHURCH, new ResourceLocationFeatureConfiguration("swamp/misc/swamp_church")),
            "swamp_church");
    public static final NamedPlacedFeature SWAMP_CHURCH_PLACED = addPlacedFeature(
            new PlacedFeature(Holder.direct(SWAMP_CHURCH_CONFIGURED.configuredFeature()), placement(YungsExtrasCommon.CONFIG.swamp.churchSpawnRate)),
            "swamp_church",
            Biome.BiomeCategory.SWAMP);
    ...
    public static void registerConfiguredFeatures() {
        NAMED_CONFIGURED_FEATURES.forEach(namedConfiguredFeature -> {
            ...
            Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new ResourceLocation(YungsExtrasCommon.MOD_ID, name), configuredFeature);
        });
    }
    ...
    public static void registerPlacedFeatures() {
        NAMED_PLACED_FEATURES.forEach(namedPlacedFeature -> {
            ...
            Registry.register(BuiltinRegistries.PLACED_FEATURE, new ResourceLocation(YungsExtrasCommon.MOD_ID, name), placedFeature);
        });
    }
}
